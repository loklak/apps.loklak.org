angular.module('myApp', ['ngStorage', 'ngMaterial', 'ngMessages',
                         'ngSanitize', 'angular-momentjs',
                         'ui.router', 'ngAnimate','loklak'])
...
.controller('MainCtrl', ['$scope', '$interval', '$localStorage',
    '$q','$sce', 'queryService', '$location',
